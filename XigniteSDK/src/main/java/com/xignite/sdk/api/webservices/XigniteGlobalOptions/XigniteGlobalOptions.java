package com.xignite.sdk.api.webservices.XigniteGlobalOptions;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.xignite.sdk.api.ApiBase;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.ExtendedOption;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.ExtendedOptionChain;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.ExtendedOptions;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.IdentifierTypes;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.NumericResult;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.Option;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionChain;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionChartBars;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionGreeks;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionGreeksByChain;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionSymbol;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.OptionTypes;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.Options;
import com.xignite.sdk.api.webservices.XigniteGlobalOptions.Models.UnderlyingSymbolList;
import com.xignite.sdk.exceptions.XigniteApiException;
import com.xignite.sdk.utilities.RestClient;
import java.util.LinkedHashMap;

public class XigniteGlobalOptions extends ApiBase {
   public XigniteGlobalOptions(String apiToken) {
      this.apiToken = apiToken;
      this.endPointUrl = "http://globaloptions.xignite.com/xglobaloptions.json";
   }
   ...
   public OptionGreeks[] getOptionGreeks(String symbols, String symbologyType, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("Symbols", String.valueOf(symbols));
         params.put("SymbologyType", String.valueOf(symbologyType));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetOptionGreeks", params);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeks[])mapper.readValue(json, OptionGreeks[].class);
      } catch (Exception var7) {
         throw new XigniteApiException(var7.getMessage());
      }
   }

   public OptionGreeks[] getOptionGreeksHTTP(String symbols, String symbologyType, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("Symbols", String.valueOf(symbols));
         params.put("SymbologyType", String.valueOf(symbologyType));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetOptionGreeks", params, false);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeks[])mapper.readValue(json, OptionGreeks[].class);
      } catch (Exception var7) {
   ...
   public OptionGreeksByChain getOptionGreeksByChain(String identifierType, String identifier, String month, String year, String symbologyType, String optionExchange, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("IdentifierType", String.valueOf(identifierType));
         ...
         params.put("OptionExchange", String.valueOf(optionExchange));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetOptionGreeksByChain", params);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeksByChain)mapper.readValue(json, OptionGreeksByChain.class);
      } catch (Exception var11) {
         throw new XigniteApiException(var11.getMessage());
      }
   }

   public OptionGreeksByChain getOptionGreeksByChainHTTP(String identifierType, String identifier, String month, String year, String symbologyType, String optionExchange, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("IdentifierType", String.valueOf(identifierType));
         ...
         params.put("OptionExchange", String.valueOf(optionExchange));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetOptionGreeksByChain", params, false);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeksByChain)mapper.readValue(json, OptionGreeksByChain.class);
      } catch (Exception var11) {
   ...
   public OptionGreeksByChain getAllOptionGreeksByChain(String identifierType, String identifier, String symbologyType, String optionExchange, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("IdentifierType", String.valueOf(identifierType));
         ...
         params.put("OptionExchange", String.valueOf(optionExchange));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetAllOptionGreeksByChain", params);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeksByChain)mapper.readValue(json, OptionGreeksByChain.class);
   ...
   public OptionGreeksByChain getAllOptionGreeksByChainHTTP(String identifierType, String identifier, String symbologyType, String optionExchange, String calculationType) throws XigniteApiException {
      try {
         LinkedHashMap<String, String> params = new LinkedHashMap();
         params.put("_token", this.apiToken);
         params.put("IdentifierType", String.valueOf(identifierType));
         ...
         params.put("OptionExchange", String.valueOf(optionExchange));
         params.put("CalculationType", String.valueOf(calculationType));
         String json = RestClient.get(this.endPointUrl + "/GetAllOptionGreeksByChain", params, false);
         ObjectMapper mapper = new ObjectMapper();
         mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
         return (OptionGreeksByChain)mapper.readValue(json, OptionGreeksByChain.class);
      } catch (Exception var9) {
